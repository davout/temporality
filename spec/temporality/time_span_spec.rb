...
describe Temporality::TimeSpan do

  before do
    @jan = Temporality::TimeSpan.new(Date.new(2010, 1, 1), Date.new(2010, 1, 31))
    @feb = Temporality::TimeSpan.new(Date.new(2010, 2, 1), Date.new(2010, 2, 28))
    @mar = Temporality::TimeSpan.new(Date.new(2010, 3, 1), Date.new(2010, 3, 31))
    @apr = Temporality::TimeSpan.new(Date.new(2010, 4, 1), Date.new(2010, 4, 30))
    @may = Temporality::TimeSpan.new(Date.new(2010, 5, 1), Date.new(2010, 5, 31))
    @jun = Temporality::TimeSpan.new(Date.new(2010, 6, 1), Date.new(2010, 6, 30))
    @jul = Temporality::TimeSpan.new(Date.new(2010, 7, 1), Date.new(2010, 7, 31))
    @aug = Temporality::TimeSpan.new(Date.new(2010, 8, 1), Date.new(2010, 8, 31))
    @sep = Temporality::TimeSpan.new(Date.new(2010, 9, 1), Date.new(2010, 9, 30))
    @oct = Temporality::TimeSpan.new(Date.new(2010, 10, 1), Date.new(2010, 10, 31))
    @nov = Temporality::TimeSpan.new(Date.new(2010, 11, 1), Date.new(2010, 11, 30))
    @dec = Temporality::TimeSpan.new(Date.new(2010, 12, 1), Date.new(2010, 12, 31))
  end
  ...
  it 'should report calendaires correctly when overlapping two years' do
    dec_09_to_jan_10 = Temporality::TimeSpan.new(Date.new(2009, 12, 1), Date.new(2010, 1, 31))
  ...
  it 'should intersect correctly' do
    ...
    ts1 = Temporality::TimeSpan.new(Date.new(2010, 1, 1), Date.new(2010, 2, 1))
    ts2 = Temporality::TimeSpan.new(Date.new(2010, 2, 1), Date.new(2010, 2, 28))

    expect(ts1.intersect(ts2)).to eql(Temporality::TimeSpan.new(Date.new(2010, 2, 1), Date.new(2010, 2, 1)))
    ...
    tsc_res = Temporality::TimeSpanCollection.new([ts4, ts5])

    expect(tsc_res).to eql(ts3.intersect(tsc))
  end

  it 'should report unequality correctly' do
    ts1 = Temporality::TimeSpan.new(Date.today, Date.today + 3)
    ts2 = Temporality::TimeSpan.new(Date.today, Date.today + 6)
